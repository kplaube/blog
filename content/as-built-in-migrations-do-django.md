...
Quem usa o [_Django_]({tag}django "Leia mais sobre Django") há mais tempo já ouviu
falar do [_South_]({tag}south "Leia mais sobre South"). Famosa biblioteca
responsável por trazer o comportamento de [_migrations_]({tag}migrations "Leia mais sobre Migrations")
...
[_Python_]({tag}python "Leia mais sobre Python") foi criado:
...
Vamos supor que exista o requisito de criar um [_API REST_]({tag}rest "Leia mais sobre REST") para o projeto,
