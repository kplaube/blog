...
Image: /images/blog/macvim-logo.png
Alt: Logotipo do MacVim

Já mencionei as motivações de utilizar [_Vim_]({tag}vim "Leia mais sobre Vim")
...
Ter o _Vim_ configurado para trabalhar com projetos [_Python_]({tag}python "Leia mais sobre Python")
...
Importante notar que se o _Vim_ for aberto dentro de um [_virtualenv_]({tag}virtualenv "Leia mais sobre Virtualenv"),
...
que o código escrito esteja dentro das convenções da [_PEP8_]({filename}assegure-a-qualidade-do-seu-codigo-python-pep8.md "Leia mais sobre PEP8").
...
repositório [_Git_]({tag}git "Leia mais sobre Git").
