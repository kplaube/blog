...
Image: /images/blog/raml-logo.png
Alt: Logotipo do RAML

Você já tem a sua [_API_]({tag}apis "Leia mais sobre APIs")! Ela é [_REST_]({tag}rest "Leia mais sobre REST"),
...
Vamos voltar ao nosso "mini IMDB", exemplo utilizado em [alguns _posts_]({tag}rest "Veja os posts sobre REST") aqui do _blog_.
...
No nosso [exemplo utilizando _Restless_]({filename}construindo-apis-em-django-com-restless.md "Construindo APIs em Django com Restless"),
