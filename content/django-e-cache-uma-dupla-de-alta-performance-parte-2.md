...
Image: /images/blog/memcached-logo.jpg
Alt: Logo do Memcached
...
[*django* e *cache*: uma dupla de alta performance]: {filename}/django-e-cache-uma-dupla-de-alta-performance-parte-1.md "Leia a parte 1 deste artigo"
[*cache*]: {tag}cache "Leia mais sobre Cache"
[*django*]: {tag}django "Leia mais sobre Django"
[*memcached*]: {tag}memcached "Leia mais sobre Memcached"
...
[cabeçalhos *http*]: {filename}/o-cache-e-o-http.md "O cache e o HTTP"
...
[já mencionei]: {filename}/nginx-poderoso-rapido-e-facil.md "Nginx: Poderoso, rápido e fácil"
