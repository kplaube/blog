...
Construir _APIs_ [_REST_]({tag}rest "Leia mais sobre REST") em
[_Django_]({tag}django "Leia mais sobre Django") nos dias atuais é uma
...
Lembra do nosso "mini IMDB", lá do [_post_ sobre _REST_]({filename}rest-parte-2.md "Leia mais sobre REST")? Vamos aproveitar a temática para exemplificar
